...
def create_dice2():
    ...
    """
    dice = list()
    dice.append(draw_dice2('dot0'))  # empty
    dice.append(draw_dice2('dot4'))  # center dot --> 1
    dice.append(draw_dice2('dot3', 'dot5'))  # dice head 2
    dice.append(draw_dice2('dot2', 'dot4', 'dot6'))  # dice head 3
    dice.append(draw_dice2('dot1', 'dot2', 'dot6', 'dot9'))  # dice head 4
    dice.append(draw_dice2('dot1', 'dot2', 'dot4', 'dot6', 'dot9'))  # dice head 5
    dice.append(draw_dice2('dot1', 'dot2', 'dot3', 'dot5', 'dot6', 'dot9'))  # dice head 6
    return dice
...
https://medium.com/usevim/how-to-write-a-cleaner-vimrc-b7c5767191ef
    ...
    for x in range(stop):
        ...
        dice_list2[dice_index].grid(row=1, column=1, columnspan=3)
        root.update()
        if x == stop - 1:
            ...
            stat.append(x%6+1)
            break
        root.after(t, dice_list2[dice_index].grid_forget()) # forgets the grid and restarts
        t += 25
    print(*stat, sep=", ")
...
dice_list2[0].grid(row=1, column=1, columnspan=3)
button = tk.Button(root, text="Roll", command=combine_funcs(click, click2))
